...
export default function AReceberPage() {
  ...
  async function loadLookups() {
    const [c1, c2, c3] = await Promise.all([
      ...
      supabase.from('categorias').select('id, nome, natureza').eq('natureza', 'receita').order('nome', { ascending: true }),
    ...
    },
    {
      ...
      render: (value: string) => (
        <Badge variant={value === 'pago' ? 'success' : value === 'pendente' ? 'warning' : 'neutral'}>
          {value === 'pago' ? 'Recebido' : value === 'pendente' ? 'Pendente' : value}
        </Badge>
      ),
    },
    {
      ...
      <div className="container max-w-7xl mx-auto px-4 py-6 space-y-4">
        ...
        <header className="mb-4">
          ...
          <div className="border-b-2 border-[#0369a1] pb-3">
            <h1 className="text-3xl font-bold text-[#0369a1] mb-1">Contas a Receber</h1>
            <p className="text-sm text-gray-600">Gestão de receitas</p>
          </div>
        </header>
        ...
        <div className="bg-white border border-gray-300">
          ...
          <div className="grid grid-cols-3 divide-x divide-gray-300 p-4">
            ...
            <div className="px-4 py-3">
              <p className="text-xs text-gray-500 uppercase mb-1">Total Recebido</p>
        ...
        <div className="bg-white border border-gray-300">
          <div className="border-b border-gray-300 bg-gray-100 px-4 py-2 flex items-center justify-between">
            <h2 className="text-sm font-semibold text-gray-700 uppercase">Contas a Receber</h2>
            <Button 
              variant="primary" 
              onClick={() => {
                setEditandoId(null);
          ...
          <div className="overflow-x-auto">
            {filteredItems.length === 0 ? (
              <div className="p-8 text-center text-gray-600">
                <p>Nenhuma conta a receber encontrada no período selecionado</p>
              </div>
            ) : (
