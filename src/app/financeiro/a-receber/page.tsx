    ...
    <main className="min-h-screen p-6 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <div className="container max-w-7xl space-y-6">
        <header className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h1 className="text-3xl font-bold text-[#0369a1]">Contas a Receber</h1>
              <p className="text-[#64748b]">Gestão de receitas</p>
            </div>
        ...
        <Table
          data={filteredItems}
          columns={columns}
          emptyMessage="Nenhuma conta a receber encontrada no período selecionado"
        />
      </div>
