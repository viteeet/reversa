-- Script corrigido para ajustar o schema do banco de dados
...
-- 3. Verificar valores permitidos para contas_financeiras.tipo
-- SELECT DISTINCT tipo FROM contas_financeiras; -- Execute isso primeiro para ver os valores válidos
...
-- 5. Inserir contas financeiras padrão (usando valores válidos)
...
('Caixa', 'caixa', 0, (SELECT id FROM auth.users LIMIT 1))
ON CONFLICT DO NOTHING;

-- 6. Inserir meios de pagamento padrão
...
-- 10. Comentários para documentar as tabelas
